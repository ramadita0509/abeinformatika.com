...
<body>
	<header class="clearfix">
		<div class="container">
			...
			<div class="company-info">
				<h2 class="title">Authorized ASUS Service Center</h2>
				<span>Jl. Ibrahim Adjie No.3a, Indihiang, Kec. Indihiang, Tasikmalaya</span>
				<span class="line"></span>
				<a class="phone" href="tel:602-519-0450">(0265) 519-0450</a>
				<span class="line"></span>
				<a class="email" href="mailto:asus@gmail.com">asus@gmail.com</a>
			</div>
	...
	<section>
		...
		<div class="container">
            <div class="company-info">
                <h2 class="title" text> {{ $trx->status->NamaBarang}} | SN : {{ $trx->status->SerialNumber}} </h2>
                </div>
			<div class="table-wrapper">
				<table>
					...
					<tbody class="body">
						{{-- <tr>
							<td class="no">01</td>
							<td class="desc">{{ $trx->status->NamaBarang}}</td>
							<td class="qty">SN : {{ $trx->status->SerialNumber}}</td>
							<td class="total">0</td>
						</tr> --}}
						<tr>
							<td class="no">01</td>
